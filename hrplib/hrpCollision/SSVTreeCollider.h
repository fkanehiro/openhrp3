...
public:
    ...
    float Distance(BVTCache& cache, Point &point0, Point&point1,
                   const Matrix4x4* world0=null, const Matrix4x4* world1=null);
private:
    float Distance(const AABBCollisionTree* tree0, 
                   const AABBCollisionTree* tree1, 
                   const Matrix4x4* world0, const Matrix4x4* world1, 
                   Pair* cache, Point &point0, Point&point1);

    float _Distance(const AABBCollisionNode* b0, const AABBCollisionNode* b1,
