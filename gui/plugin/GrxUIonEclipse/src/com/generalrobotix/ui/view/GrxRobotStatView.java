...
public class GrxRobotStatView extends GrxBaseView {
    ...
    public GrxRobotStatView(String name, GrxPluginManager manager, GrxBaseViewPart vp, Composite parent) {
        ...
        String[][] header = new String[][] {
                { "No", "Joint", "Angle", "Target", "Current", "PWR", "SRV",
                        "Pgain", "Dgain" },
                { "Force", "Fx[N]", "Fy[N]", "Fz[N]", "Mx[Nm]", "My[Nm]",
                        "Mz[Nm]" }, { "Sensor", "Xaxis", "Yaxis", "Zaxis" } };
        int[][] alignment = new int[][] {
                { SWT.LEFT, SWT.LEFT, SWT.RIGHT, SWT.RIGHT,
                        SWT.RIGHT, SWT.CENTER, SWT.CENTER,
                        SWT.RIGHT, SWT.RIGHT },
        ...
        int[][] columnSize = new int[][] {
                ...
                { 102, 51, 50, 51, 50, 51, 50 }, { 102, 101, 100, 100 } };
