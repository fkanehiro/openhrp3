...
class TestCompile(unittest.TestCase):
    ...
    def pkg_config_variable(self, var):
        return check_output("%s pkg-config openhrp3.2 --variable=%s"%(self.PKG_CONFIG_PATH, var), shell=True).rstrip()
    ...
    def check_if_file_exists(self, var, fname):
        ...
        self.assertTrue(pkg_ret, "pkg-config openhrp3.2 --variable=%s`/%s (%s) returns %r"%(pkg_var, fname, pkg_path, pkg_ret))
    ...
    def test_files_for_hrpsys(self):
        ...
        # self.check_if_file_exists_from_rospack("share/OpenHRP-3.2/sample/project")
        self.check_if_file_exists_from_prefix("share/OpenHRP-3.2/sample/project")
        ...
        # self.check_if_file_exists_from_rospack("share/OpenHRP-3.2/sample/model/PA10/pa10.main.wrl")
    ...
    def test_files_for_hrpsys_ros_bridge(self):
        ...
        # self.check_if_file_exists_from_rospack("share/OpenHRP-3.2/sample/controller/SampleController/etc/Sample.pos")
        self.check_if_file_exists_from_prefix("share/OpenHRP-3.2/sample/controller/SampleController/etc/Sample.pos")
        ...
        self.check_if_file_exists_from_prefix("share/OpenHRP-3.2/sample/model/PA10/pa10.main.wrl")
        self.check_if_file_exists_from_prefix("share/OpenHRP-3.2/sample/model/sample1.wrl")
        # self.check_if_file_exists_from_rospack("share/OpenHRP-3.2/sample/model/PA10/pa10.main.wrl")
        # self.check_if_file_exists_from_rospack("share/OpenHRP-3.2/sample/model/sample1.wrl")

    ## test 1 == 1
    def test_compile_pkg_config(self):
        global PID
        cmd = "%s pkg-config openhrp3.2 --cflags --libs"%(self.PKG_CONFIG_PATH)
    ...
    def _test_compile_move_ankle(self):
        cmd1 = "pkg-config openhrp3.2 --cflags --libs"
        cmd2 = "pkg-config openhrp3.2 --variable=idl_dir"
    ...
    def test_idl_dir(self):
        cmd = "%s pkg-config openhrp3.2 --variable=idl_dir"%(self.PKG_CONFIG_PATH)
    ...
    def test_sample_pa10(self):
        ...
        cmd = "%s pkg-config openhrp3.2 --variable=prefix"%(self.PKG_CONFIG_PATH)
        fname = "share/OpenHRP-3.2/sample/model/PA10/pa10.main.wrl"
        # check if model file exists
        print "`"+cmd+"`"+fname+" = "+os.path.join(check_output(cmd, shell=True).rstrip(), fname)
        self.assertTrue(os.path.exists(os.path.join(check_output(cmd, shell=True).rstrip(), fname)))
    ...
    def test_sample_samplerobot(self):
        ...
        cmd = "%s pkg-config openhrp3.2 --variable=prefix"%(self.PKG_CONFIG_PATH)
        fname = "share/OpenHRP-3.2/sample/model/sample1.wrl"
        # check if model file exists
        print "`"+cmd+"`"+fname+" = "+os.path.join(check_output(cmd, shell=True).rstrip(), fname)
        self.assertTrue(os.path.exists(os.path.join(check_output(cmd, shell=True).rstrip(), fname)), "cmd = %r, fname = %r"%(cmd, fname))
        #
        # check if walk data file exists
        fname = "share/OpenHRP-3.2/sample/controller/SampleController/etc/Sample.pos"
        print "`"+cmd+"`"+fname+" = "+os.path.join(check_output(cmd, shell=True).rstrip(), fname)
        self.assertTrue(os.path.exists(os.path.join(check_output(cmd, shell=True).rstrip(), fname)), "cmd = %r, fname = %r"%(cmd, fname))
