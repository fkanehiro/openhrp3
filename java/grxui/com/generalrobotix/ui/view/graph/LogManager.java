...
public class LogManager {
    ...
    private static final String COLLISION_LOG_FILENAME = "CollisionData.col";
    private static String COLLISION_LOG = COLLISION_LOG_FILENAME;
...
//    private LogManager() {}
     ...
     *  保存
     */
    public void openAsWrite(SimulationTime time, String method)
        throws IOException
    {
    ...
    public void putCollisionPointData(CollisionPoint[] data)
        throws LogFileOutputException, IOException{
        ...
        if (collisionLog_.numRecords_ + 1 > collisionLog_.position_.length )
        {
            throw new LogFileOutputException("Assumed time step is over.");
        }
    ...
    public void save(String fileName, String prjFileName) throws IOException {
        try {
            ...
            for (
                ...
                ZipEntry zipEntry = new ZipEntry(header.objectName_+POSTFIX);
            ...
            if (collisionFile.exists()) {
                ...
                ZipEntry zipEntry = new ZipEntry(COLLISION_LOG_FILENAME);
                zip.putNextEntry(zipEntry);
