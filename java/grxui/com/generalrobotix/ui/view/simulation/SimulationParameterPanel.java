...
public class SimulationParameterPanel extends JPanel {
  ...
  public void updateItem(GrxBaseItem item) {
	  ...
	  if (item != null) { 
		  setTotalTime(item.getDbl("totalTime",
		          com.generalrobotix.ui.item.GrxWorldStateItem.DEFAULT_TOTAL_TIME));
		  setStepTime(item.getDbl("timeStep",
		          com.generalrobotix.ui.item.GrxWorldStateItem.DEFAULT_STEP_TIME));
		  setLogStepTime(item.getDbl("logTimeStep",
		          com.generalrobotix.ui.item.GrxWorldStateItem.DEFAULT_STEP_TIME));
