...
public class GrxWorldStateItem extends GrxTimeSeriesItem {
	...
	public GrxWorldStateItem(String name, GrxPluginManager manager) {
		...
		tempDir_ = System.getProperty("java.io.tmpdir")+"/grxui-"+System.getProperty("user.name")+File.separator+getName();
...
// ##### [Changed] #####
   //2008-03-06時点のModelLoaderでは，この箇所で問題が発生する場合がある。
   //現在原因調査中。
...
//System.out.println( "    addValue() : 2.7.8"  );
	...
	private static class SensorInfoLocal implements Comparable {
		String name;
		String type; //#####[Changed] int -> string に変更する！
		int id;
