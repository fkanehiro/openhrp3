...
//    private ArrayList<AttributeInfo> addedList_;
    ...
    //--------------------------------------------------------------------
    public GraphPanel(GrxPluginManager manager, TrendGraphManager trendGraphMgr) {
        manager_ = manager;
    	owner_ = manager_.getFrame();
...
//        DataItemInfo dii;
        ...
        seriesDialog_ = new SeriesDialog(manager_, currentGraph_);
